...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $target = "../images/".basename($image);
        ...
        if($password === $confirm_password) {
            $sql = "INSERT INTO `users` (`id`, `name`, `fathers_name`, `course`, `section`, `department`, `semester`, `user_type`, `password`, `image`) VALUES ('$id', '$name', '$fathers_name', '$course', '$section', '$department', '$semester', 'teacher', MD5('$password'), '$image');";
            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card shadow-2-strong" style="border-radius: 1rem;">
                    <div class="card-body p-5">
                        ...
                        ?>
                        <h2 class="text-center mb-3">Create Teacher Account</h2>
