...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $confirm_password = $_POST['confirm_password'];
        ...
        if($password === $confirm_password) {
            $sql = "INSERT INTO `users` (`id`, `name`, `fathers_name`, `course`, `section`, `department`, `semester`, `user_type`, `password`) VALUES ('$id', '$name', '$fathers_name', '$course', '$section', '$department', '$semester', 'student', MD5('$password'));";
