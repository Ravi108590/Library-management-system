...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if( $count == 1 ) {
        ...
        setcookie("type", "user", time() + (86400 * 30), "/"); // 86400 = 1 day
        setcookie("id", $id, time() + (86400 * 30), "/"); // 86400 = 1 day
        setcookie("login_time", date("d M Y h:i:s"), time() + (86400 * 30), "/"); // 86400 = 1 day
        ...
        <div class="container py-5 h-100">
            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="card-body p-5 text-center">
                    ...
                    <button class="btn btn-block btn-secondary" type="submit">Create Account</button>
                    </a>
                </div>
                </div>
            </div>
