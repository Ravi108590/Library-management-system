            ...
            <div class="col-12">
                <form method="GET">
                    <div class="d-flex align-items-center mt-3">
                        <h2 class="m-1">Current Books Status</h2>
                        <a class="btn btn-primary btn-sm " href="export.php">Export Full Report</a>
                    </div>
                    <div class="form-group mt-3">
                        <div class="input-group mb-3">
                            <input type="text" placeholder="Book Title" class="form-control" name="book_name" value="<?php echo $book_name; ?>">
